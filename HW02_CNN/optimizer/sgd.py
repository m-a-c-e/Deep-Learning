    ...
    def update(self, model):
        ...
        for idx, m in enumerate(model.modules):
            if hasattr(m, 'weight'):
                ...
                #############################################################################
                vt = self.momentum * self.grad_tracker[idx]['dw'] - self.learning_rate*m.dw
                m.weight += vt
                self.grad_tracker[idx]['dw'] = vt
                #############################################################################
                #                              END OF YOUR CODE                             #
                #############################################################################
            if hasattr(m, 'bias'):
                ...
                #############################################################################
                vt = self.momentum * self.grad_tracker[idx]['db'] - self.learning_rate*m.db
                m.bias += vt
                self.grad_tracker[idx]['db'] = vt
                #############################################################################
                #                              END OF YOUR CODE                             #
                #############################################################################